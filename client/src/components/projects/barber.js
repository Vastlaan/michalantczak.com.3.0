...
import Barber1 from "../../img/barberGallery.png";
import Barber2 from "../../img/barberMain.png";
import Barber3 from "../../img/barberPrices.png";

export default function Barber({ intl }) {
    const photosNameArray = [Barber1, Barber2, Barber3];
    ...
    return (
        <Main>
            <h3>{intl.formatMessage({ id: "projectsBarberHeader" })}</h3>
            <Galery>
                <ButtonLeft
                    onClick={() =>
                        shufflePhoto(
            ...
            <Description>
                <div>
                    <p>
                        <strong>
                            {intl.formatMessage({ id: "projectsBarberStrong" })}
                        </strong>{" "}
                        {intl.formatMessage({
                            id: "projectsBarberDescription",
                        })}
                    </p>
                </div>
                <div>
                    <a href="https://kapsalon.michalantczak.com">
                        Visit website
                    </a>
