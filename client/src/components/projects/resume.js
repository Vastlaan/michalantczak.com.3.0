...
import Resume1 from "../../img/resumeMain.png";
import Resume2 from "../../img/resumeHow.png";
import Resume3 from "../../img/resumeContact.png";

export default function Resume({ intl }) {
    const photosNameArray = [Resume1, Resume2, Resume3];
    ...
    return (
        <Main>
            <h3>{intl.formatMessage({ id: "projectsResumeHeader" })}</h3>
            <Galery>
                <ButtonLeft
                    onClick={() =>
                        shufflePhoto(
            ...
            <Description>
                <div>
                    <p>
                        {intl.formatMessage({
                            id: "projectsResumeDescription",
                        })}
                    </p>
                </div>
                <div>
                    <a href="https://www.royalresumegenerator.com">
                        Visit website
                    </a>
